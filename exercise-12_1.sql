...
-- 3. Select the customers first name in lower case and their last
-- name in upper case for each customer with a last name of 'Smith'.
...
-- 5. Concatenate the first three letters in the first_name and
